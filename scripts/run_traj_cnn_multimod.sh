...
python3 train_generator_only.py \
  ...
  --print_every 200 \
  --num_epochs 50 \
  --checkpoint_name organized_cnn_$1_4lay_5ker \
  --output_dir organized_cnn_models_multi \
  --loader_num_workers 8 \
  --restore_from_checkpoint $2

echo "TESTING NOW epochs 50" 
python3 evaluate_generator_only.py --model_path organized_cnn_models_multi/organized_cnn_$1_4lay_5ker_with_model.pt
